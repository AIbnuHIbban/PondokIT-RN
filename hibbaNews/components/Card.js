...
export default class Card extends Component {
    render() {
        return (
            <View style={{marginVertical:10,paddingBottom:10,paddingHorizontal:10,shadowColor: "#000",shadowOffset: {width: 5,height: 12,},shadowOpacity: 0.58,shadowRadius: 16.00,elevation: 24}}>
